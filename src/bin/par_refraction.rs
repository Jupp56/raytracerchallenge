...
fn main() {
    ...
    middle.material_mut().color = ColorType::Color(WHITE);
    middle.material_mut().diffuse = 0.7;
    middle.material_mut().specular = 0.3;
    middle.material_mut().refractive_index = 1.3;
    middle.material_mut().transparency = 1.0;
    ...
    let mut file = File::create("./refractive.ppm").unwrap();
